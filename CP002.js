describe('CP002-Aplicar filtro de equipos -Gama.Alta -Memoria Interna.256GB', function(){
    ...
    it('Utilizar filtros de página "Gama Alta" & "256GB"', function(){
        ...
        cy.get('.toolbar-bottom > .toolbar > .pager > .count-container > .amount > strong').should('contain','Artículo(s)'); // Se checkea la cantidad de artículos que devuelve la busqueda.
    }) 
})
